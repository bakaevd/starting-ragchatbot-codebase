...
"""
    ...
    def generate_response(self, query: str,
        ...
        for round_num in range(max_tool_rounds):
            ...
            if not self._should_continue_tool_rounds(messages, round_num + 1, max_tool_rounds):
                break
    ...
    def _execute_single_round(self, messages: List[Dict], system_content: str, tools: Optional[List]):
        """
    ...
    def _handle_tool_execution_round(self, response, messages: List[Dict], 
                                   tool_manager, round_num: int) -> List[Dict]:
        """
    ...
    def _should_continue_tool_rounds(self, messages: List[Dict], 
        ...
        if len(messages) >= 2:
            ...
            if last_message and last_message.get("role") == "user":
                ...
                for result in last_message.get("content", []):
                    if isinstance(result, dict) and "Tool execution failed" in str(result.get("content", "")):
                        return False
